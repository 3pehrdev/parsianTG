...
local function run(msg, matches)
  if matches[1]:lower() == 'parsiantg' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "parsiantg" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) ([Pp]arsian[Tt][Gg])",-- Put everything you like :)
		"^[!/]([Pp]arsian[Tt][Gg])"-- Put everything you like :)
    }, 
  run = run
}
